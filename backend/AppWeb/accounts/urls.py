...
# from django.contrib.auth import (password_reset_complete, password_reset_confirm, password_reset_done, password_reset, login, logout)
...
profile_patterns = [
    # path('login/', login, {'template_name': 'accounts/login.html', 'authentication_form': forms.CustomAuthenticationForm}, name='login'),
